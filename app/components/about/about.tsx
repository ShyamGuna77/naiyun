...
import { MyLinks } from "../navbar/Header";
            ...
            <div className="space-y-4">
              ...
              <Reveal>
                <p className="leading-relaxed text-zinc-300">
                  ...
                  you&apos;ll find me scribbling some happy clouds with my son
                  ☁️ I even teach courses online if you&apos;re looking to
                  learn!
                </p>
              </Reveal>
              <Reveal>
                <p className="leading-relaxed text-zinc-300">
                  ...
                  you&apos;ve got an opening that I might like, let&apos;s
                  connect 🔗
                </p>
              </Reveal>
              <Reveal>
